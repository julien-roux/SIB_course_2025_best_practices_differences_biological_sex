...
```{r}
## Visualize how some of the factors separate on the PCA, for example sex is associated to PC3
plotPCA(vst, 
        ntop = 500,
...
Although this is not tested explicitely, a main aim o fthe study is to identify genes reacting differently to Tamoxifen treatment in male and female. It is possible to test this by extracting the interaction between sex and tratment.
